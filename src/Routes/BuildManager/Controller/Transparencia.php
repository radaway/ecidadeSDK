...
class Transparencia{
  ...
  private function dockerStop(){
    ...
    try {
      ...
      $dockerId = $dockerL->getDockerByDir( '/var/www/builds/' . $this->buildName . '/builds/Transparencia' );
      if ( $dockerId == null ){
        return $msg;
      }
  ...
  private function dockerStart(){
    ...
    $dockerPort = file_get_contents( '/var/www/builds/' . $this->buildName . '/builds/Transparencia_ports.conf');
    ...
    try {
      ...
      $dockerJson->addVolume( '/var/www/builds/' . $this->buildName . '/builds/Transparencia', "/var/www/html" );
