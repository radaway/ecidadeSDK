...
class EcidadeOnline{
  ...
  private function dockerStop(){
    ...
    try {
      ...
      $dockerId = $dockerL->getDockerByDir( '/var/www/builds/' . $this->buildName . '/builds/EcidadeOnline' );
      if ( $dockerId == null ){
        return $msg;
      }
  ...
  private function dockerStart(){
    ...
    $dockerPort = file_get_contents( '/var/www/builds/' . $this->buildName . '/builds/EcidadeOnline_ports.conf');
    ...
    try {
      ...
      $dockerJson->addVolume( '/var/www/builds/' . $this->buildName . '/builds/EcidadeOnline', "/var/www/html" );
