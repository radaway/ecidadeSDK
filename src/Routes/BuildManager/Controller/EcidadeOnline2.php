...
class EcidadeOnline2{
  ...
  private function dockerStop(){
    ...
    try {
      ...
      $dockerId = $dockerL->getDockerByDir( '/var/www/builds/' . $this->buildName . '/builds/EcidadeOnline2' );
      if ( $dockerId == null ){
        return $msg;
      }
  ...
  private function dockerStart(){
    ...
    try {
      ...
      $dockerJson = new DockerJsonCreate( "apache_nfse" );
      $dockerJson->addVolume( '/var/www/builds/' . $this->buildName . '/builds/EcidadeOnline2', "/var/www/html" );
