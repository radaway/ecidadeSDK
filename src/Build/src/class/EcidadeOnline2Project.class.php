...
Class EcidadeOnline2Project implements Project{
  ...
  public function buildVersion( $Versao ){
    try {
      ...
      $cmd = self::RSYNC_BIN . " -r -t -s rsync://" . $ServerName . ".dbseller.com.br/memcache/e-cidadeonline2/" . $Versao . "/e-cidadeonline2.completo/* " . $this->Path . "/";
        echo "Executando:" . $cmd . "\n";
        Bash::exec( $cmd );
      } catch (Exception $e) {
        throw $e;
    ...
    public function checkoutTag( $Tags ){
      ...
      $cvs->GetFilesByTags( "e-cidadeonline2", $this->Path, $Tags );
    }
